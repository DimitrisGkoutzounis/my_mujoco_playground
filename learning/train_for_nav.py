...
from mujoco_playground.config import navigation_params
...
_ENV_NAME = flags.DEFINE_string(
    "env_name",
    "Go2NavigationFlatTerrain",  #"LeapCubeReorient", changed this
...
def get_rl_config(env_name: str) -> config_dict.ConfigDict:
  if env_name in mujoco_playground.dynamic_events._envs:
    return navigation_params.brax_ppo_config(env_name=env_name)
